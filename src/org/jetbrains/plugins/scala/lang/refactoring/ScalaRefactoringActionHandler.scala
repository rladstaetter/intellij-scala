...
trait ScalaRefactoringActionHandler extends RefactoringActionHandler {
  ...
  def invoke(file: PsiFile)(implicit project: Project, editor: Editor, dataContext: DataContext): Unit
  ...
  override final def invoke(project: Project, elements: Array[PsiElement], dataContext: DataContext): Unit =
